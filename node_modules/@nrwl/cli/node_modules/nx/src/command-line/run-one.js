...
function parseRunOneOptions(cwd, parsedArgs, projectGraph, nxJson) {
    const defaultProjectName = calculateDefaultProjectName(cwd, workspace_root_1.workspaceRoot, Object.assign(Object.assign({}, (0, project_graph_1.readProjectsConfigurationFromProjectGraph)(projectGraph)), nxJson));
    let project;
    let target;
    let configuration;
