...
function workspaceConfigName(root, opts) {
    if ((0, fs_1.existsSync)(path.join(root, 'angular.json')) &&
        ...
        ((opts === null || opts === void 0 ? void 0 : opts.includeProjectsFromAngularJson) ||
...
class Workspaces {
    ...
    readWorkspaceConfiguration(opts) {
        ...
        const workspaceFile = workspaceConfigName(this.root, {
            includeProjectsFromAngularJson: opts === null || opts === void 0 ? void 0 : opts._includeProjectsFromAngularJson,
        });
        if (workspaceFile) {
